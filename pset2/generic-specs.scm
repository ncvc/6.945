...
;;; ================= EDITED FOR PROBLEM 2.2 =================
;;; (sequence:append <sequence-1> ... <sequence-n>)
;;;    Does not require that the sequences are all of the same type.  Returns
;;;    a new sequence of the type (sequence:type <sequence-1>), formed by concatenating the
...
;;;    Requires that the sequences given are of the same size,
;;;    and that the arity of the function is n.  The ith element
;;;    of the new sequence is the value of the function applied to the
;;;    n ith elements of the given sequences. The new sequence is of
;;;    type (sequence:type <seq-1>).

;;; ================= EDITED FOR PROBLEM 2.2 =================
;;; (sequence:for-each <procedure> <seq-1> ... <seq-n>)
;;;    Requires that the sequences given are of the same size,
;;;    and that the arity of the procedure is n.  Applies the
